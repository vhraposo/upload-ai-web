import { FileVideo, Github, Upload, Video, Wand2 } from 'lucide-react'
          ...
          <div className='space-y-2'>
            ...
            <div className='space-y-4'>
              ...
              <Slider 
                ...
                step={0.1}
              />
              <span className='block text-xs text-muted-foreground italic leading-relaxed'>Valores mias altos tendem a deixar o resultado mais criativo e com possíveis erros.</span>
            </div>
            <Separator />
